...
PROJECT_NAME="Qwen3_Stu_4B_Tea_A3B_Ins_Math_Code_Uni_OPD"
...
# 训练数据配置
TRAIN_DATA_FILE="exps/scripts/OPD/strong_to_weak/configs/Qwen3_Stu_4B_Tea_A3B_Ins_Math_Code_Uni_OPD.yaml"
INPUT_KEY="prompt"
