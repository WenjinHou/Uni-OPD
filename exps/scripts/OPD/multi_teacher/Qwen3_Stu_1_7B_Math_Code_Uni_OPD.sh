...
PROJECT_NAME="Qwen3_Stu_1_7B_Math_Code_Uni_OPD"
EXPERIMENT_NAME="" # 空则自动生成
TEACHER_MODEL_NAME="Qwen3-4B-RL"
...
# 训练数据配置
TRAIN_DATA_FILE="exps/scripts/OPD/multi_teacher/configs/Qwen3_Stu_1_7B_Math_Code_OPD.yaml"
INPUT_KEY="prompt"
