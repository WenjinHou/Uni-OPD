...
- **学生视角：离线难度感知数据均衡**。我们对训练语料按难度重新均衡，让学生更多地接触难度适中的样本，从而把算力花在真正具有信息量的自采样状态上，而不是在过于简单或完全无解的样本上空转。
<table align="center">
    <p align="center">
...
- **学生视角：在线正确性感知数据均衡**。在训练过程中，我们动态过滤并重塑 rollout batch，维持正确轨迹与错误轨迹之间的合理比例，避免学生坍缩到「全部正确」的简单样本，也防止被「全部失败」的样本完全淹没。
<table align="center">
    <p align="center">
